...
results = ConsensusClusterPlus(dt,maxK=10,reps=100,pItem=0.8,pFeature=1,title="CNV_CC",distance="pearson",clusterAlg="hc",seed=1262118388.71279)

results %>%
  readr::write_rds(file.path("/project/huff/huff/immune_checkpoint/genelist_data","genelist_CNV_CC_10.rds.gz"),compress = "gz")