...
ConsensusClusterPlus(combine_data.m, maxK=20, reps=500,pItem=0.8,pFeature=1, title="recode.combined.ConsensusClusterplus", 
                     clusterAlg="hc",distance="pearson",seed=1262118388.71279, plot = "pdf") -> cc_res
