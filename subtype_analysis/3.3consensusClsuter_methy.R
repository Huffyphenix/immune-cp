...
PanCan26_gene_list_methy_matrix <- readr::read_rds(file.path(data_result_path,"PanCan26_gene_list_methy_matrix.scaled.rds.gz"))
...
results %>%
  readr::write_rds(file.path("/project/huff/huff/immune_checkpoint/genelist_data","genelist_methy_scaled_CC_20.rds.gz"),compress = "gz")

source("/project/huff/huff/github/immune-cp/subtype_analysis/4.3get_best_clusterK_methy.R")
