...
results <- readr::read_rds(file.path(basic_path,"immune_checkpoint/genelist_data","genelist_methy_alltag-scaled_CC_20.rds.gz"))

# get best K for cluster results  -----------------------------------------
source(file.path(basic_path,"github/immune-cp/subtype_analysis/funtions_to_draw_pic.R"))

result_path <- file.path(basic_path,"immune_checkpoint/result_20171025/subtype_analysis","methy_alltags-scaled","Get_best_clutser_20")
